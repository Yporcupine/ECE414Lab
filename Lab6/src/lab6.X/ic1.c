...
#include "ic1.h"
   ...
   // indicate capture since last readPeriod
    ...
    void ic1_init() {
        ...
        PPSInput(3, IC1, RPA4);          // connect PIN 6 to IC1 capture unit
        mPORTBSetPinsDigitalIn(BIT_4);  // Set port as input (important!)
        capture1 = 0;
        last_capture1 = 0;
        capture_period = 0;
    }    
